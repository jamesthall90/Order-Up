...
public class CalorieCalculator extends JFrame {
    ...
    public CalorieCalculator() {
        ...
        gainTwoLbsTextField = new JTextField(5);
        gainTwoLbsLabel = new JLabel("Gain 2 lbs/week:");
        gainOneLbsTextField = new JTextField(5);
        gainOneLbsLabel = new JLabel("Gain 1 lb/week:");
        maintainWeightTextField = new JTextField(5);
        maintainWeightLabel = new JLabel("Maintain weight:");
        loseOneLbsTextField = new JTextField(5);
        loseOneLbsLabel = new JLabel("Lose 1 lb/week:");
        loseTwoLbsTextField = new JTextField(5);
        ...
        ageTextField.setBounds(40, 50, 50, 20);
        ageLabel.setBounds(5, 44, 30, 30);
        maleRadioButton.setBounds(40, 100, 20, 20);
        maleLabel.setBounds(5, 100, 40, 20);
        femaleRadioButton.setBounds(120, 100, 20, 20);
        femaleLabel.setBounds(70, 100, 50, 20);
        heightTextField.setBounds(80, 150, 50, 20);
        heightLabel.setBounds(5, 150, 80, 20);
        weightTextField.setBounds(80, 200, 50, 20);
        weightLabel.setBounds(5, 200, 80, 20);
        activityComboBox.setBounds(5, 280, 250, 20);
        activityLabel.setBounds(5, 250, 150, 20);
        calculateButton.setBounds(140, 330, 100, 20);
        caloriesLabel.setBounds(340, 30, 50, 20);
        gainTwoLbsTextField.setBounds(340, 50, 50, 20);
        gainTwoLbsLabel.setBounds(220, 50, 100, 20);
        gainOneLbsTextField.setBounds(340, 100, 50, 20);
        gainOneLbsLabel.setBounds(225, 100, 100, 20);
        maintainWeightTextField.setBounds(340, 150, 50, 20);
        maintainWeightLabel.setBounds(220, 150, 100, 20);
        loseOneLbsTextField.setBounds(340, 200, 50, 20);
        loseOneLbsLabel.setBounds(225, 200, 100, 20);
        loseTwoLbsTextField.setBounds(340, 250, 50, 20);
        loseTwoLbsLabel.setBounds(220, 250, 100, 20);
        screenTitle.setBounds(20, 5, 350, 20);
